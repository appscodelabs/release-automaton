...
func CreateKubeStashReleaseFile() api.Release {
	...
	return api.Release{
		...
		Projects: []api.IndependentProjects{
			{
				"github.com/kubestash/apimachinery": api.Project{Tag: TagP("v0.16.0", prerelease)},
			},
			{
				"github.com/kubestash/kubestash":          api.Project{Tag: TagP("v0.16.0", prerelease)},
				"github.com/kubestash/pvc":                api.Project{Tag: TagP("v0.15.0", prerelease)},
				"github.com/kubestash/workload":           api.Project{Tag: TagP("v0.15.0", prerelease)},
				"github.com/kubestash/kubedump":           api.Project{Tag: TagP("v0.15.0", prerelease)},
				"github.com/kubestash/volume-snapshotter": api.Project{Tag: TagP("v0.15.0", prerelease)},
				"github.com/kubestash/manifest":           api.Project{Tag: TagP("v0.8.0", prerelease)},

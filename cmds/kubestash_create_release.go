			...
			},
			{
				"github.com/kubestash/installer": api.Project{
					...
					Commands: []string{
						...
						"go run ./hack/fmt/main.go --kind=Function --name=kubedump-restore --update-spec=spec.image=ghcr.io/kubestash/kubedump:${KUBESTASH_KUBEDUMP_TAG}",
						"go run ./hack/fmt/main.go --kind=Function --name=kubevirt-backup --update-spec=spec.image=ghcr.io/kubestash/kubevirt-plugin:${KUBESTASH_KUBEVIRT_TAG}",
						"go run ./hack/fmt/main.go --kind=Function --name=kubevirt-restore --update-spec=spec.image=ghcr.io/kubestash/kubevirt-plugin:${KUBESTASH_KUBEVIRT_TAG}",
						"go run ./hack/fmt/main.go --kind=Function --name=kubevirt-manifest-backup --update-spec=spec.image=ghcr.io/kubestash/kubevirt-plugin:${KUBESTASH_KUBEVIRT_TAG}",
						"go run ./hack/fmt/main.go --kind=Function --name=kubevirt-manifest-restore --update-spec=spec.image=ghcr.io/kubestash/kubevirt-plugin:${KUBESTASH_KUBEVIRT_TAG}",
						"go run ./hack/fmt/main.go --kind=Function --name=kubevirt-volume-backup --update-spec=spec.image=ghcr.io/kubestash/kubevirt-plugin:${KUBESTASH_KUBEVIRT_TAG}",
						"go run ./hack/fmt/main.go --kind=Function --name=kubevirt-volume-restore --update-spec=spec.image=ghcr.io/kubestash/kubevirt-plugin:${KUBESTASH_KUBEVIRT_TAG}",

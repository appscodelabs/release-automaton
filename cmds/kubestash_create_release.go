...
func CreateKubeStashReleaseFile() api.Release {
	...
	return api.Release{
		...
		Projects: []api.IndependentProjects{
			{
				"github.com/kubestash/apimachinery": api.Project{Tag: TagP("v0.27.0", prerelease)},
			},
			{
				"github.com/kubestash/kubestash":          api.Project{Tag: TagP("v0.27.0", prerelease)},
				"github.com/kubestash/pvc":                api.Project{Tag: TagP("v0.26.0", prerelease)},
				"github.com/kubestash/workload":           api.Project{Tag: TagP("v0.26.0", prerelease)},

...
func CreateKubeStashReleaseFile() api.Release {
	prerelease := ""
	releaseNumber := "v2024.8.30" + prerelease
	return api.Release{
		...
		Projects: []api.IndependentProjects{
			{
				"github.com/kubestash/apimachinery": api.Project{Tag: TagP("v0.12.0", prerelease)},
			},
			{
				"github.com/kubestash/kubestash":          api.Project{Tag: TagP("v0.12.0", prerelease)},
				"github.com/kubestash/pvc":                api.Project{Tag: TagP("v0.11.0", prerelease)},
				"github.com/kubestash/workload":           api.Project{Tag: TagP("v0.11.0", prerelease)},
				"github.com/kubestash/kubedump":           api.Project{Tag: TagP("v0.11.0", prerelease)},
				"github.com/kubestash/volume-snapshotter": api.Project{Tag: TagP("v0.11.0", prerelease)},
				"github.com/kubestash/manifest":           api.Project{Tag: TagP("v0.4.0", prerelease)},

...
func CreateKubeDBReleaseFile() api.Release {
	prerelease := ""
	releaseNumber := "v2024.2.14" + prerelease
	return api.Release{
		ProductLine:       "KubeDB",
		...
		Projects: []api.IndependentProjects{
			{
				"github.com/kubedb/apimachinery": api.Project{Tag: TagP("v0.42.0", prerelease)},
			},
			{
				"github.com/kubedb/db-client-go": api.Project{Tag: TagP("v0.0.11", prerelease)},
			},
			{
				...
				"github.com/kubedb/crd-manager":                api.Project{Tag: TagP("v0.0.5", prerelease)},
				"github.com/kubedb/druid":                      api.Project{Tag: TagP("v0.0.5", prerelease)},
				"github.com/kubedb/ferretdb":                   api.Project{Tag: TagP("v0.0.5", prerelease)},
				"github.com/kubedb/pgpool":                     api.Project{Tag: TagP("v0.0.5", prerelease)},
				"github.com/kubedb/rabbitmq":                   api.Project{Tag: TagP("v0.0.5", prerelease)},
				"github.com/kubedb/singlestore":                api.Project{Tag: TagP("v0.0.5", prerelease)},
				"github.com/kubedb/singlestore-coordinator":    api.Project{Tag: TagP("v0.0.5", prerelease)},
				"github.com/kubedb/solr":                       api.Project{Tag: TagP("v0.0.5", prerelease)},
				"github.com/kubedb/zookeeper":                  api.Project{Tag: TagP("v0.0.5", prerelease)},
				"github.com/kubedb/elasticsearch":              api.Project{Tag: TagP("v0.42.0", prerelease)},
				"github.com/kubedb/kafka":                      api.Project{Tag: TagP("v0.13.0", prerelease)},
				"github.com/kubedb/mariadb":                    api.Project{Tag: TagP("v0.26.0", prerelease)},
				"github.com/kubedb/mariadb-coordinator":        api.Project{Tag: TagP("v0.22.0", prerelease)},
				"github.com/kubedb/memcached":                  api.Project{Tag: TagP("v0.35.0", prerelease)},
				"github.com/kubedb/mongodb":                    api.Project{Tag: TagP("v0.35.0", prerelease)},
				"github.com/kubedb/mysql":                      api.Project{Tag: TagP("v0.35.0", prerelease)},
				"github.com/kubedb/mysql-coordinator":          api.Project{Tag: TagP("v0.20.0", prerelease)},
				"github.com/kubedb/mysql-router-init":          api.Project{Tag: TagP("v0.20.0", prerelease)},
				"github.com/kubedb/percona-xtradb":             api.Project{Tag: TagP("v0.29.0", prerelease)},
				"github.com/kubedb/percona-xtradb-coordinator": api.Project{Tag: TagP("v0.15.0", prerelease)},
				"github.com/kubedb/pg-coordinator":             api.Project{Tag: TagP("v0.26.0", prerelease)},
				"github.com/kubedb/postgres":                   api.Project{Tag: TagP("v0.42.0", prerelease)},
				"github.com/kubedb/redis":                      api.Project{Tag: TagP("v0.35.0", prerelease)},
				"github.com/kubedb/redis-coordinator":          api.Project{Tag: TagP("v0.21.0", prerelease)},
				"github.com/kubedb/replication-mode-detector":  api.Project{Tag: TagP("v0.29.0", prerelease)},
				"github.com/kubedb/tests":                      api.Project{Tag: TagP("v0.27.0", prerelease)},
				// kubestash plugins
				"github.com/kubedb/elasticsearch-restic-plugin":     api.Project{Tag: TagP("v0.5.0", prerelease)},
				"github.com/kubedb/kubedb-manifest-plugin":          api.Project{Tag: TagP("v0.5.0", prerelease)},
				"github.com/kubedb/mariadb-archiver":                api.Project{Tag: TagP("v0.2.0", prerelease)},
				"github.com/kubedb/mariadb-csi-snapshotter-plugin":  api.Project{Tag: TagP("v0.2.0", prerelease)},
				"github.com/kubedb/mongodb-csi-snapshotter-plugin":  api.Project{Tag: TagP("v0.3.0", prerelease)},
				"github.com/kubedb/mongodb-restic-plugin":           api.Project{Tag: TagP("v0.5.0", prerelease)},
				"github.com/kubedb/mysql-archiver":                  api.Project{Tag: TagP("v0.3.0", prerelease)},
				"github.com/kubedb/mysql-csi-snapshotter-plugin":    api.Project{Tag: TagP("v0.3.0", prerelease)},
				"github.com/kubedb/mysql-restic-plugin":             api.Project{Tag: TagP("v0.5.0", prerelease)},
				"github.com/kubedb/postgres-archiver":               api.Project{Tag: TagP("v0.3.0", prerelease)},
				"github.com/kubedb/postgres-csi-snapshotter-plugin": api.Project{Tag: TagP("v0.3.0", prerelease)},
				"github.com/kubedb/postgres-restic-plugin":          api.Project{Tag: TagP("v0.5.0", prerelease)},
				"github.com/kubedb/redis-restic-plugin":             api.Project{Tag: TagP("v0.5.0", prerelease)},
				// crossplane
				"github.com/kubedb/provider-aws":   api.Project{Tag: TagP("v0.4.0", prerelease)},
				"github.com/kubedb/provider-azure": api.Project{Tag: TagP("v0.4.0", prerelease)},
				"github.com/kubedb/provider-gcp":   api.Project{Tag: TagP("v0.4.0", prerelease)},
			},
			{

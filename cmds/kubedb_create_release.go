	...
	return api.Release{
		...
		Projects: []api.IndependentProjects{
			...
			},
			{
				...
				"github.com/kubedb/solr-plugin":                     api.Project{Tag: TagP("v0.1.0", prerelease)},
			...
			// Build Enterprise image
			{
				"github.com/kubedb/installer": api.Project{
					...
					Commands: []string{
						...
						"go run ./catalog/kubestash/fmt/main.go --kind=Function --name=solr-backup --update-spec=spec.image=ghcr.io/kubedb/solr-plugin:${KUBEDB_SOLR_PLUGIN_TAG}",
						"go run ./catalog/kubestash/fmt/main.go --kind=Function --name=solr-restore --update-spec=spec.image=ghcr.io/kubedb/solr-plugin:${KUBEDB_SOLR_PLUGIN_TAG}",

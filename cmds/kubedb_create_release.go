...
func CreateKubeDBReleaseFile() api.Release {
	releaseNumber := "v2020.10.27-rc.2"
	return api.Release{
		ProductLine:       "KubeDB",
		...
		Projects: []api.IndependentProjects{
			...
			},
			{
				"github.com/kubedb/docs": api.Project{
					Key:           "kubedb",
					Tag:           github.String("v2020.10.27-rc.2"),

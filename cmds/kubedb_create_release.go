	...
	return api.Release{
		...
		Projects: []api.IndependentProjects{
			...
			},
			{
				...
				"github.com/kubedb/rabbitmq":                   api.Project{Tag: TagP("v0.0.10", prerelease)},
				"github.com/kubedb/singlestore":                api.Project{Tag: TagP("v0.0.8", prerelease)},
				"github.com/kubedb/singlestore-coordinator":    api.Project{Tag: TagP("v0.0.8", prerelease)},
				"github.com/kubedb/solr":                       api.Project{Tag: TagP("v0.0.10", prerelease)},
				"github.com/kubedb/zookeeper":                  api.Project{Tag: TagP("v0.0.9", prerelease)},

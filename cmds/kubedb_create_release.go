...
func CreateKubeDBReleaseFile() api.Release {
	...
	return api.Release{
		...
		Projects: []api.IndependentProjects{
			{
				"github.com/kubedb/apimachinery": api.Project{Tag: TagP("v0.65.0", prerelease)},
			},
			{
				"github.com/kubedb/db-client-go": api.Project{Tag: TagP("v0.20.0", prerelease)},
				"github.com/kubedb/crd-manager":  api.Project{Tag: TagP("v0.20.0", prerelease)},
			},
			{
				...
				"github.com/kubedb/singlestore-coordinator":    api.Project{Tag: TagP("v0.20.0", prerelease)},
				"github.com/kubedb/solr":                       api.Project{Tag: TagP("v0.20.0", prerelease)},
				"github.com/kubedb/zookeeper":                  api.Project{Tag: TagP("v0.20.0", prerelease)},
				"github.com/kubedb/elasticsearch":              api.Project{Tag: TagP("v0.65.0", prerelease)},
				"github.com/kubedb/kafka":                      api.Project{Tag: TagP("v0.36.0", prerelease)},
				"github.com/kubedb/mariadb":                    api.Project{Tag: TagP("v0.49.0", prerelease)},
				"github.com/kubedb/mariadb-coordinator":        api.Project{Tag: TagP("v0.45.0", prerelease)},
				"github.com/kubedb/memcached":                  api.Project{Tag: TagP("v0.58.0", prerelease)},
				"github.com/kubedb/mongodb":                    api.Project{Tag: TagP("v0.58.0", prerelease)},
				"github.com/kubedb/mssqlserver":                api.Project{Tag: TagP("v0.20.0", prerelease)},
				"github.com/kubedb/mssql-coordinator":          api.Project{Tag: TagP("v0.20.0", prerelease)},
				"github.com/kubedb/mysql":                      api.Project{Tag: TagP("v0.58.0", prerelease)},
				"github.com/kubedb/mysql-coordinator":          api.Project{Tag: TagP("v0.43.0", prerelease)},
				"github.com/kubedb/mysql-router-init":          api.Project{Tag: TagP("v0.43.0", prerelease)},
				"github.com/kubedb/percona-xtradb":             api.Project{Tag: TagP("v0.52.0", prerelease)},
				"github.com/kubedb/percona-xtradb-coordinator": api.Project{Tag: TagP("v0.38.0", prerelease)},
				"github.com/kubedb/pg-coordinator":             api.Project{Tag: TagP("v0.49.0", prerelease)},
				"github.com/kubedb/postgres":                   api.Project{Tag: TagP("v0.65.0", prerelease)},
				"github.com/kubedb/redis":                      api.Project{Tag: TagP("v0.58.0", prerelease)},
				"github.com/kubedb/redis-coordinator":          api.Project{Tag: TagP("v0.44.0", prerelease)},
				"github.com/kubedb/replication-mode-detector":  api.Project{Tag: TagP("v0.52.0", prerelease)},
				"github.com/kubedb/tests":                      api.Project{Tag: TagP("v0.50.0", prerelease)},
				"github.com/kubedb/cassandra":                  api.Project{Tag: TagP("v0.18.0", prerelease)},
				"github.com/kubedb/hazelcast":                  api.Project{Tag: TagP("v0.11.0", prerelease)},
				"github.com/kubedb/oracle":                     api.Project{Tag: TagP("v0.11.0", prerelease)},
				"github.com/kubedb/oracle-coordinator":         api.Project{Tag: TagP("v0.11.0", prerelease)},
				"github.com/kubedb/db2":                        api.Project{Tag: TagP("v0.6.0", prerelease)},
				"github.com/kubedb/db2-coordinator":            api.Project{Tag: TagP("v0.6.0", prerelease)},
				"github.com/kubedb/hanadb":                     api.Project{Tag: TagP("v0.6.0", prerelease)},
				"github.com/kubedb/hanadb-coordinator":         api.Project{Tag: TagP("v0.5.0", prerelease)},
				"github.com/kubedb/milvus":                     api.Project{Tag: TagP("v0.6.0", prerelease)},
				"github.com/kubedb/neo4j":                      api.Project{Tag: TagP("v0.6.0", prerelease)},
				"github.com/kubedb/qdrant":                     api.Project{Tag: TagP("v0.6.0", prerelease)},
				"github.com/kubedb/weaviate":                   api.Project{Tag: TagP("v0.6.0", prerelease)},
				...
				"github.com/kubedb/mariadb-archiver":                api.Project{Tag: TagP("v0.25.0", prerelease)},
				"github.com/kubedb/mongodb-csi-snapshotter-plugin":  api.Project{Tag: TagP("v0.26.0", prerelease)},
				"github.com/kubedb/mariadb-restic-plugin":           api.Project{Tag: TagP("v0.23.0", prerelease)},
				"github.com/kubedb/mongodb-restic-plugin":           api.Project{Tag: TagP("v0.28.0", prerelease)},
				"github.com/kubedb/mysql-archiver":                  api.Project{Tag: TagP("v0.26.0", prerelease)},
				"github.com/kubedb/mysql-csi-snapshotter-plugin":    api.Project{Tag: TagP("v0.26.0", prerelease)},
				"github.com/kubedb/mysql-restic-plugin":             api.Project{Tag: TagP("v0.28.0", prerelease)},
				"github.com/kubedb/xtrabackup-restic-plugin":        api.Project{Tag: TagP("v0.13.0", prerelease)},
				"github.com/kubedb/postgres-archiver":               api.Project{Tag: TagP("v0.26.0", prerelease)},
				"github.com/kubedb/postgres-csi-snapshotter-plugin": api.Project{Tag: TagP("v0.26.0", prerelease)},
				"github.com/kubedb/postgres-restic-plugin":          api.Project{Tag: TagP("v0.28.0", prerelease)},
				"github.com/kubedb/redis-restic-plugin":             api.Project{Tag: TagP("v0.28.0", prerelease)},
				"github.com/kubedb/qdrant-restic-plugin":            api.Project{Tag: TagP("v0.1.0", prerelease)},
				"github.com/kubedb/singlestore-restic-plugin":       api.Project{Tag: TagP("v0.23.0", prerelease)},
				"github.com/kubedb/zookeeper-restic-plugin":         api.Project{Tag: TagP("v0.20.0", prerelease)},
				"github.com/kubedb/mssqlserver-walg-plugin":         api.Project{Tag: TagP("v0.19.0", prerelease)},
				"github.com/kubedb/mssqlserver-archiver":            api.Project{Tag: TagP("v0.19.0", prerelease)},
				"github.com/kubedb/gitops":                          api.Project{Tag: TagP("v0.13.0", prerelease)},
				"github.com/kubedb/kubedb-verifier":                 api.Project{Tag: TagP("v0.16.0", prerelease)},
				"github.com/kubedb/ignite":                          api.Project{Tag: TagP("v0.12.0", prerelease)},
				"github.com/kubedb/cassandra-medusa-plugin":         api.Project{Tag: TagP("v0.12.0", prerelease)},
				// crossplane
				"github.com/kubedb/provider-aws":   api.Project{Tag: TagP("v0.26.0", prerelease)},
				"github.com/kubedb/provider-azure": api.Project{Tag: TagP("v0.26.0", prerelease)},
				"github.com/kubedb/provider-gcp":   api.Project{Tag: TagP("v0.26.0", prerelease)},
			},
			{
				"github.com/kubedb/mariadb-csi-snapshotter-plugin": api.Project{Tag: TagP("v0.25.0", prerelease)},
				"github.com/kubedb/migrator-operator":              api.Project{Tag: TagP("v0.5.0", prerelease)},
			...
			// Build Enterprise image
			{
				"github.com/kubedb/installer": api.Project{
					...
					Commands: []string{
						...
						"go run ./catalog/kubedb/fmt/main.go --kind=MariaDBVersion --update-spec=spec.migrator.cli.image=ghcr.io/kubedb/mariadb-migrator-cli:${KUBEDB_MIGRATOR_CLI_TAG}",
						"go run ./catalog/kubedb/fmt/main.go --kind=MariaDBVersion --update-spec=spec.migrator.statusReporter.image=ghcr.io/kubedb/migrator-operator:${KUBEDB_MIGRATOR_OPERATOR_TAG}",
						"go run ./catalog/kubedb/fmt/main.go --kind=MongoDBVersion --update-spec=spec.migrator.cli.image=ghcr.io/kubedb/mongodb-migrator-cli:${KUBEDB_MIGRATOR_CLI_TAG}",
						"go run ./catalog/kubedb/fmt/main.go --kind=MongoDBVersion --update-spec=spec.migrator.statusReporter.image=ghcr.io/kubedb/migrator-operator:${KUBEDB_MIGRATOR_OPERATOR_TAG}",
						...
						"go run ./catalog/kubedb/fmt/main.go --kind=MySQLVersion --update-spec=spec.migrator.cli.image=ghcr.io/kubedb/mysql-migrator-cli:${KUBEDB_MIGRATOR_CLI_TAG}",
						"go run ./catalog/kubedb/fmt/main.go --kind=MySQLVersion --update-spec=spec.migrator.statusReporter.image=ghcr.io/kubedb/migrator-operator:${KUBEDB_MIGRATOR_OPERATOR_TAG}",
						...
						"go run ./catalog/kubedb/fmt/main.go --kind=PostgresVersion --update-spec=spec.migrator.cli.image=ghcr.io/kubedb/postgresql-migrator-cli:${KUBEDB_MIGRATOR_CLI_TAG}",
						...
						"make chart-kubedb-migrator CHART_VERSION=${KUBEDB_MIGRATOR_OPERATOR_TAG} CHART_REGISTRY=${CHART_REGISTRY} CHART_REGISTRY_URL=${CHART_REGISTRY_URL}",

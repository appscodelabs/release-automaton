	...
	return api.Release{
		...
		Projects: []api.IndependentProjects{
			...
			},
			{
				...
				// kubestash plugins
				"github.com/kubedb/dashboard-restic-plugin":         api.Project{Tag: TagP("v0.1.0", prerelease)},
				...
				"github.com/kubedb/mariadb-restic-plugin":           api.Project{Tag: TagP("v0.1.0", prerelease)},

...
func CreateKubeDBReleaseFile() api.Release {
	prerelease := ""
	releaseNumber := "v2024.4.27" + prerelease
	return api.Release{
		ProductLine:       "KubeDB",
		...
		Projects: []api.IndependentProjects{
			...
			},
			{
				...
				"github.com/kubedb/crd-manager":                api.Project{Tag: TagP("v0.0.9", prerelease)},
				"github.com/kubedb/druid":                      api.Project{Tag: TagP("v0.0.9", prerelease)},
				"github.com/kubedb/ferretdb":                   api.Project{Tag: TagP("v0.0.9", prerelease)},
				"github.com/kubedb/pgpool":                     api.Project{Tag: TagP("v0.0.9", prerelease)},
				"github.com/kubedb/rabbitmq":                   api.Project{Tag: TagP("v0.0.11", prerelease)},
				"github.com/kubedb/singlestore":                api.Project{Tag: TagP("v0.0.9", prerelease)},
				"github.com/kubedb/singlestore-coordinator":    api.Project{Tag: TagP("v0.0.8", prerelease)},
				"github.com/kubedb/solr":                       api.Project{Tag: TagP("v0.0.11", prerelease)},
				"github.com/kubedb/zookeeper":                  api.Project{Tag: TagP("v0.0.10", prerelease)},
				"github.com/kubedb/elasticsearch":              api.Project{Tag: TagP("v0.45.0", prerelease)},
				"github.com/kubedb/kafka":                      api.Project{Tag: TagP("v0.16.0", prerelease)},
				"github.com/kubedb/mariadb":                    api.Project{Tag: TagP("v0.29.0", prerelease)},
				...
				"github.com/kubedb/percona-xtradb":             api.Project{Tag: TagP("v0.32.0", prerelease)},
				"github.com/kubedb/percona-xtradb-coordinator": api.Project{Tag: TagP("v0.18.0", prerelease)},
				"github.com/kubedb/pg-coordinator":             api.Project{Tag: TagP("v0.29.0", prerelease)},
				"github.com/kubedb/postgres":                   api.Project{Tag: TagP("v0.45.0", prerelease)},
				"github.com/kubedb/redis":                      api.Project{Tag: TagP("v0.38.0", prerelease)},
				"github.com/kubedb/redis-coordinator":          api.Project{Tag: TagP("v0.24.0", prerelease)},
				"github.com/kubedb/replication-mode-detector":  api.Project{Tag: TagP("v0.32.0", prerelease)},
				"github.com/kubedb/tests":                      api.Project{Tag: TagP("v0.30.0", prerelease)},
				// kubestash plugins
				"github.com/kubedb/dashboard-restic-plugin":         api.Project{Tag: TagP("v0.3.0", prerelease)},
				"github.com/kubedb/elasticsearch-restic-plugin":     api.Project{Tag: TagP("v0.8.0", prerelease)},
				"github.com/kubedb/kubedb-manifest-plugin":          api.Project{Tag: TagP("v0.8.0", prerelease)},
				"github.com/kubedb/mariadb-archiver":                api.Project{Tag: TagP("v0.5.0", prerelease)},
				"github.com/kubedb/mariadb-csi-snapshotter-plugin":  api.Project{Tag: TagP("v0.5.0", prerelease)},
				"github.com/kubedb/mongodb-csi-snapshotter-plugin":  api.Project{Tag: TagP("v0.6.0", prerelease)},
				"github.com/kubedb/mariadb-restic-plugin":           api.Project{Tag: TagP("v0.3.0", prerelease)},
				"github.com/kubedb/mongodb-restic-plugin":           api.Project{Tag: TagP("v0.8.0", prerelease)},
				"github.com/kubedb/mysql-archiver":                  api.Project{Tag: TagP("v0.6.0", prerelease)},
				"github.com/kubedb/mysql-csi-snapshotter-plugin":    api.Project{Tag: TagP("v0.6.0", prerelease)},
				"github.com/kubedb/mysql-restic-plugin":             api.Project{Tag: TagP("v0.8.0", prerelease)},
				"github.com/kubedb/postgres-archiver":               api.Project{Tag: TagP("v0.6.0", prerelease)},
				"github.com/kubedb/postgres-csi-snapshotter-plugin": api.Project{Tag: TagP("v0.6.0", prerelease)},
				...
				"github.com/kubedb/provider-gcp":   api.Project{Tag: TagP("v0.7.0", prerelease)},
			},
			{

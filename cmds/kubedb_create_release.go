...
func CreateKubeDBReleaseFile() api.Release {
	prerelease := ""
	releaseNumber := "v2023.01.17" + prerelease
	return api.Release{
		ProductLine:       "KubeDB",
		...
		Projects: []api.IndependentProjects{
			{
				"github.com/kubedb/apimachinery": api.Project{
					Tag: github.String("v0.30.1" + prerelease),
				},
			},
			{
				...
				"github.com/kubedb/mariadb": api.Project{
					Tag: github.String("v0.14.1" + prerelease),
				},
				"github.com/kubedb/memcached": api.Project{
					Tag: github.String("v0.23.1" + prerelease),
				},
				...
				"github.com/kubedb/percona-xtradb": api.Project{
					Tag: github.String("v0.17.1" + prerelease),
				},
				...
				"github.com/kubedb/mariadb-coordinator": api.Project{
					Tag: github.String("v0.10.1" + prerelease),
					// update catalog
				},
				"github.com/kubedb/mysql-coordinator": api.Project{
					Tag: github.String("v0.8.1" + prerelease),
					// update catalog
				},
				...
				"github.com/kubedb/percona-xtradb-coordinator": api.Project{
					Tag: github.String("v0.3.1" + prerelease),
					// update catalog
				},
				"github.com/kubedb/redis-coordinator": api.Project{
					Tag: github.String("v0.9.1" + prerelease),
					// update catalog
				},
				...
				"github.com/kubedb/tests": api.Project{
					Tag: github.String("v0.15.1" + prerelease),
				},
			},
			{
			...
			},
			{
				...
				"github.com/kubedb/dashboard": api.Project{
					...
					Tag: github.String("v0.6.1" + prerelease),
					ChartNames: []string{
						"kubedb-dashboard",
					},
				},

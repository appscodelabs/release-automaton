			...
			// Build Enterprise image
			{
				"github.com/kubedb/installer": api.Project{
					...
					Commands: []string{
						...
						"go run ./catalog/kubestash/fmt/main.go --kind=Function --name=opostgres-csisnapshotter --update-spec=spec.image=ghcr.io/kubedb/postgres-csi-snapshotter-plugin:${KUBEDB_POSTGRES_CSI_SNAPSHOTTER_PLUGIN_TAG}",

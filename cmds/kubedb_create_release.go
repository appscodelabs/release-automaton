...
func CreateKubeDBReleaseFile() api.Release {
	...
	return api.Release{
		...
		Projects: []api.IndependentProjects{
			...
			{
				"github.com/kubedb/db-client-go": api.Project{Tag: TagP("v0.16.0", prerelease)},
				"github.com/kubedb/crd-manager":  api.Project{Tag: TagP("v0.16.0", prerelease)},
			},
			{
				"github.com/kubedb/cli": api.Project{
					Key: "kubedb-cli",
					Tag: TagP("v0.61.0", prerelease),
				},
				"github.com/kubedb/clickhouse":                 api.Project{Tag: TagP("v0.16.0", prerelease)},
				"github.com/kubedb/druid":                      api.Project{Tag: TagP("v0.16.0", prerelease)},
				"github.com/kubedb/ferretdb":                   api.Project{Tag: TagP("v0.16.0", prerelease)},
				"github.com/kubedb/pgpool":                     api.Project{Tag: TagP("v0.16.0", prerelease)},
				"github.com/kubedb/rabbitmq":                   api.Project{Tag: TagP("v0.16.0", prerelease)},
				"github.com/kubedb/singlestore":                api.Project{Tag: TagP("v0.16.0", prerelease)},
				"github.com/kubedb/singlestore-coordinator":    api.Project{Tag: TagP("v0.16.0", prerelease)},
				"github.com/kubedb/solr":                       api.Project{Tag: TagP("v0.16.0", prerelease)},
				"github.com/kubedb/zookeeper":                  api.Project{Tag: TagP("v0.16.0", prerelease)},
				"github.com/kubedb/elasticsearch":              api.Project{Tag: TagP("v0.61.0", prerelease)},
				"github.com/kubedb/kafka":                      api.Project{Tag: TagP("v0.32.0", prerelease)},
				"github.com/kubedb/mariadb":                    api.Project{Tag: TagP("v0.45.0", prerelease)},
				"github.com/kubedb/mariadb-coordinator":        api.Project{Tag: TagP("v0.41.0", prerelease)},
				"github.com/kubedb/memcached":                  api.Project{Tag: TagP("v0.54.0", prerelease)},
				"github.com/kubedb/mongodb":                    api.Project{Tag: TagP("v0.54.0", prerelease)},
				"github.com/kubedb/mssqlserver":                api.Project{Tag: TagP("v0.16.0", prerelease)},
				"github.com/kubedb/mssql-coordinator":          api.Project{Tag: TagP("v0.16.0", prerelease)},
				"github.com/kubedb/mysql":                      api.Project{Tag: TagP("v0.54.0", prerelease)},
				"github.com/kubedb/mysql-coordinator":          api.Project{Tag: TagP("v0.39.0", prerelease)},
				"github.com/kubedb/mysql-router-init":          api.Project{Tag: TagP("v0.39.0", prerelease)},
				"github.com/kubedb/percona-xtradb":             api.Project{Tag: TagP("v0.48.0", prerelease)},
				"github.com/kubedb/percona-xtradb-coordinator": api.Project{Tag: TagP("v0.34.0", prerelease)},
				"github.com/kubedb/pg-coordinator":             api.Project{Tag: TagP("v0.45.0", prerelease)},
				"github.com/kubedb/postgres":                   api.Project{Tag: TagP("v0.61.0", prerelease)},
				"github.com/kubedb/redis":                      api.Project{Tag: TagP("v0.54.0", prerelease)},
				"github.com/kubedb/redis-coordinator":          api.Project{Tag: TagP("v0.40.0", prerelease)},
				"github.com/kubedb/replication-mode-detector":  api.Project{Tag: TagP("v0.48.0", prerelease)},
				"github.com/kubedb/tests":                      api.Project{Tag: TagP("v0.46.0", prerelease)},
				"github.com/kubedb/cassandra":                  api.Project{Tag: TagP("v0.14.0", prerelease)},
				"github.com/kubedb/hazelcast":                  api.Project{Tag: TagP("v0.7.0", prerelease)},
				"github.com/kubedb/oracle":                     api.Project{Tag: TagP("v0.7.0", prerelease)},
				"github.com/kubedb/oracle-coordinator":         api.Project{Tag: TagP("v0.7.0", prerelease)},
				...
				"github.com/kubedb/kubedb-manifest-plugin":          api.Project{Tag: TagP("v0.24.0", prerelease)},
				"github.com/kubedb/mariadb-archiver":                api.Project{Tag: TagP("v0.21.0", prerelease)},
				"github.com/kubedb/mongodb-csi-snapshotter-plugin":  api.Project{Tag: TagP("v0.22.0", prerelease)},
				"github.com/kubedb/mariadb-restic-plugin":           api.Project{Tag: TagP("v0.19.0", prerelease)},
				"github.com/kubedb/mongodb-restic-plugin":           api.Project{Tag: TagP("v0.24.0", prerelease)},
				"github.com/kubedb/mysql-archiver":                  api.Project{Tag: TagP("v0.22.0", prerelease)},
				"github.com/kubedb/mysql-csi-snapshotter-plugin":    api.Project{Tag: TagP("v0.22.0", prerelease)},
				"github.com/kubedb/mysql-restic-plugin":             api.Project{Tag: TagP("v0.24.0", prerelease)},
				"github.com/kubedb/xtrabackup-restic-plugin":        api.Project{Tag: TagP("v0.9.0", prerelease)},
				"github.com/kubedb/postgres-archiver":               api.Project{Tag: TagP("v0.22.0", prerelease)},
				"github.com/kubedb/postgres-csi-snapshotter-plugin": api.Project{Tag: TagP("v0.22.0", prerelease)},
				"github.com/kubedb/postgres-restic-plugin":          api.Project{Tag: TagP("v0.24.0", prerelease)},
				"github.com/kubedb/redis-restic-plugin":             api.Project{Tag: TagP("v0.24.0", prerelease)},
				"github.com/kubedb/singlestore-restic-plugin":       api.Project{Tag: TagP("v0.19.0", prerelease)},
				"github.com/kubedb/zookeeper-restic-plugin":         api.Project{Tag: TagP("v0.16.0", prerelease)},
				"github.com/kubedb/mssqlserver-walg-plugin":         api.Project{Tag: TagP("v0.15.0", prerelease)},
				"github.com/kubedb/mssqlserver-archiver":            api.Project{Tag: TagP("v0.15.0", prerelease)},
				"github.com/kubedb/gitops":                          api.Project{Tag: TagP("v0.9.0", prerelease)},
				"github.com/kubedb/kubedb-verifier":                 api.Project{Tag: TagP("v0.12.0", prerelease)},
				"github.com/kubedb/ignite":                          api.Project{Tag: TagP("v0.8.0", prerelease)},
				"github.com/kubedb/cassandra-medusa-plugin":         api.Project{Tag: TagP("v0.8.0", prerelease)},
				// crossplane
				"github.com/kubedb/provider-aws":   api.Project{Tag: TagP("v0.22.0", prerelease)},
				"github.com/kubedb/provider-azure": api.Project{Tag: TagP("v0.22.0", prerelease)},
				"github.com/kubedb/provider-gcp":   api.Project{Tag: TagP("v0.22.0", prerelease)},
			},
			{

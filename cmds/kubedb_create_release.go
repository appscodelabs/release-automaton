...
func CreateKubeDBReleaseFile() api.Release {
	prerelease := "-rc.1"
	releaseNumber := "v2024.1.28" + prerelease
	return api.Release{
		ProductLine:       "KubeDB",
		...
		Projects: []api.IndependentProjects{
			...
			},
			{
				...
				"github.com/kubedb/crd-manager":                api.Project{Tag: TagP("v0.0.3", prerelease)},
				"github.com/kubedb/druid":                      api.Project{Tag: TagP("v0.0.3", prerelease)},
				"github.com/kubedb/ferretdb":                   api.Project{Tag: TagP("v0.0.3", prerelease)},
				"github.com/kubedb/pgpool":                     api.Project{Tag: TagP("v0.0.3", prerelease)},
				"github.com/kubedb/rabbitmq":                   api.Project{Tag: TagP("v0.0.3", prerelease)},
				"github.com/kubedb/singlestore":                api.Project{Tag: TagP("v0.0.3", prerelease)},
				"github.com/kubedb/singlestore-coordinator":    api.Project{Tag: TagP("v0.0.3", prerelease)},
				"github.com/kubedb/solr":                       api.Project{Tag: TagP("v0.0.3", prerelease)},
				"github.com/kubedb/zookeeper":                  api.Project{Tag: TagP("v0.0.3", prerelease)},

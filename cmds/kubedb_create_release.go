...
func CreateKubeDBReleaseFile() api.Release {
	prerelease := "-rc.2"
	releaseNumber := "v2026.8.26" + prerelease
	...
	return api.Release{
		...
		Projects: []api.IndependentProjects{
			{
				"github.com/kubedb/apimachinery": api.Project{Tag: TagP("v0.67.0", prerelease)},
			},
			{
				"github.com/kubedb/db-client-go": api.Project{Tag: TagP("v0.22.0", prerelease)},
				"github.com/kubedb/crd-manager":  api.Project{Tag: TagP("v0.22.0", prerelease)},
			},
			{
				"github.com/kubedb/cli": api.Project{
					Key: "kubedb-cli",
					Tag: TagP("v0.67.0", prerelease),
				},
				"github.com/kubedb/aerospike":                  api.Project{Tag: TagP("v0.3.0", prerelease)},
				"github.com/kubedb/clickhouse":                 api.Project{Tag: TagP("v0.22.0", prerelease)},
				...
				"github.com/kubedb/singlestore-coordinator":    api.Project{Tag: TagP("v0.22.0", prerelease)},
				"github.com/kubedb/solr":                       api.Project{Tag: TagP("v0.22.0", prerelease)},
				"github.com/kubedb/zookeeper":                  api.Project{Tag: TagP("v0.22.0", prerelease)},
				"github.com/kubedb/elasticsearch":              api.Project{Tag: TagP("v0.67.0", prerelease)},
				"github.com/kubedb/kafka":                      api.Project{Tag: TagP("v0.38.0", prerelease)},
				"github.com/kubedb/mariadb":                    api.Project{Tag: TagP("v0.51.0", prerelease)},
				"github.com/kubedb/mariadb-coordinator":        api.Project{Tag: TagP("v0.47.0", prerelease)},
				"github.com/kubedb/memcached":                  api.Project{Tag: TagP("v0.61.0", prerelease)},
				"github.com/kubedb/mongodb":                    api.Project{Tag: TagP("v0.60.0", prerelease)},
				"github.com/kubedb/mssqlserver":                api.Project{Tag: TagP("v0.22.0", prerelease)},
				"github.com/kubedb/mssql-coordinator":          api.Project{Tag: TagP("v0.22.0", prerelease)},
				"github.com/kubedb/mysql":                      api.Project{Tag: TagP("v0.60.0", prerelease)},
				"github.com/kubedb/mysql-coordinator":          api.Project{Tag: TagP("v0.45.0", prerelease)},
				"github.com/kubedb/mysql-router-init":          api.Project{Tag: TagP("v0.45.0", prerelease)},
				"github.com/kubedb/percona-xtradb":             api.Project{Tag: TagP("v0.54.0", prerelease)},
				"github.com/kubedb/percona-xtradb-coordinator": api.Project{Tag: TagP("v0.40.0", prerelease)},
				"github.com/kubedb/pg-coordinator":             api.Project{Tag: TagP("v0.51.0", prerelease)},
				"github.com/kubedb/postgres":                   api.Project{Tag: TagP("v0.67.0", prerelease)},
				"github.com/kubedb/redis":                      api.Project{Tag: TagP("v0.60.0", prerelease)},
				"github.com/kubedb/redis-coordinator":          api.Project{Tag: TagP("v0.46.0", prerelease)},
				"github.com/kubedb/replication-mode-detector":  api.Project{Tag: TagP("v0.54.0", prerelease)},
				"github.com/kubedb/tests":                      api.Project{Tag: TagP("v0.52.0", prerelease)},
				"github.com/kubedb/cassandra":                  api.Project{Tag: TagP("v0.20.0", prerelease)},
				"github.com/kubedb/hazelcast":                  api.Project{Tag: TagP("v0.13.0", prerelease)},
				"github.com/kubedb/oracle":                     api.Project{Tag: TagP("v0.13.0", prerelease)},
				"github.com/kubedb/oracle-coordinator":         api.Project{Tag: TagP("v0.13.0", prerelease)},
				"github.com/kubedb/db2":                        api.Project{Tag: TagP("v0.8.0", prerelease)},
				"github.com/kubedb/db2-coordinator":            api.Project{Tag: TagP("v0.8.0", prerelease)},
				"github.com/kubedb/hanadb":                     api.Project{Tag: TagP("v0.8.0", prerelease)},
				"github.com/kubedb/hanadb-coordinator":         api.Project{Tag: TagP("v0.7.0", prerelease)},
				"github.com/kubedb/milvus":                     api.Project{Tag: TagP("v0.8.0", prerelease)},
				"github.com/kubedb/neo4j":                      api.Project{Tag: TagP("v0.8.0", prerelease)},
				"github.com/kubedb/qdrant":                     api.Project{Tag: TagP("v0.8.0", prerelease)},
				...
				"github.com/kubedb/oracle-backup-plugin":            api.Project{Tag: TagP("v0.1.0", prerelease)},
				"github.com/kubedb/solr-backup-plugin":              api.Project{Tag: TagP("v0.1.0", prerelease)},
				...
				"github.com/kubedb/kubedb-manifest-plugin":          api.Project{Tag: TagP("v0.30.0", prerelease)},
				"github.com/kubedb/mariadb-archiver":                api.Project{Tag: TagP("v0.27.0", prerelease)},
				"github.com/kubedb/mongodb-csi-snapshotter-plugin":  api.Project{Tag: TagP("v0.28.0", prerelease)},
				"github.com/kubedb/mariadb-restic-plugin":           api.Project{Tag: TagP("v0.25.0", prerelease)},
				"github.com/kubedb/mongodb-restic-plugin":           api.Project{Tag: TagP("v0.30.0", prerelease)},
				"github.com/kubedb/mysql-archiver":                  api.Project{Tag: TagP("v0.28.0", prerelease)},
				"github.com/kubedb/mysql-csi-snapshotter-plugin":    api.Project{Tag: TagP("v0.28.0", prerelease)},
				"github.com/kubedb/mysql-restic-plugin":             api.Project{Tag: TagP("v0.30.0", prerelease)},
				"github.com/kubedb/xtrabackup-restic-plugin":        api.Project{Tag: TagP("v0.15.0", prerelease)},
				"github.com/kubedb/postgres-archiver":               api.Project{Tag: TagP("v0.28.0", prerelease)},
				"github.com/kubedb/postgres-csi-snapshotter-plugin": api.Project{Tag: TagP("v0.28.0", prerelease)},
				"github.com/kubedb/postgres-restic-plugin":          api.Project{Tag: TagP("v0.30.0", prerelease)},
				"github.com/kubedb/redis-restic-plugin":             api.Project{Tag: TagP("v0.30.0", prerelease)},
				"github.com/kubedb/qdrant-restic-plugin":            api.Project{Tag: TagP("v0.3.0", prerelease)},
				"github.com/kubedb/singlestore-restic-plugin":       api.Project{Tag: TagP("v0.25.0", prerelease)},
				"github.com/kubedb/zookeeper-restic-plugin":         api.Project{Tag: TagP("v0.22.0", prerelease)},
				"github.com/kubedb/mssqlserver-walg-plugin":         api.Project{Tag: TagP("v0.21.0", prerelease)},
				"github.com/kubedb/mssqlserver-archiver":            api.Project{Tag: TagP("v0.21.0", prerelease)},
				"github.com/kubedb/gitops":                          api.Project{Tag: TagP("v0.15.0", prerelease)},
				"github.com/kubedb/kubedb-verifier":                 api.Project{Tag: TagP("v0.18.0", prerelease)},
				"github.com/kubedb/ignite":                          api.Project{Tag: TagP("v0.14.0", prerelease)},
				"github.com/kubedb/cassandra-medusa-plugin":         api.Project{Tag: TagP("v0.14.0", prerelease)},
				// crossplane
				"github.com/kubedb/provider-aws":   api.Project{Tag: TagP("v0.28.0", prerelease)},
				"github.com/kubedb/provider-azure": api.Project{Tag: TagP("v0.28.0", prerelease)},
				"github.com/kubedb/provider-gcp":   api.Project{Tag: TagP("v0.28.0", prerelease)},
			},
			{
				"github.com/kubedb/clickhouse-backup-plugin":       api.Project{Tag: TagP("v0.4.0", prerelease)},
				"github.com/kubedb/mariadb-csi-snapshotter-plugin": api.Project{Tag: TagP("v0.27.0", prerelease)},
				"github.com/kubedb/courier":                        api.Project{Tag: TagP("v0.7.0", prerelease)},
				"github.com/kubedb/pgbouncer": api.Project{
					Tag: TagP("v0.54.0", prerelease),
					Commands: []string{
			...
			// Build Enterprise image
			{
				"github.com/kubedb/installer": api.Project{
					...
					Commands: []string{
						...
						"go run ./catalog/kubedb/fmt/main.go --kind=MariaDBVersion --update-spec=spec.courier.cli.image=ghcr.io/kubedb/kubedb-migrator-mariadb:${KUBEDB_MIGRATOR_TAG}",
						"go run ./catalog/kubedb/fmt/main.go --kind=MariaDBVersion --update-spec=spec.courier.statusReporter.image=ghcr.io/kubedb/kubedb-courier:${KUBEDB_COURIER_TAG}",
						"go run ./catalog/kubedb/fmt/main.go --kind=MongoDBVersion --update-spec=spec.courier.cli.image=ghcr.io/kubedb/kubedb-migrator-mongodb:${KUBEDB_MIGRATOR_TAG}",
						...
						"go run ./catalog/kubedb/fmt/main.go --kind=MySQLVersion --update-spec=spec.courier.statusReporter.image=ghcr.io/kubedb/kubedb-courier:${KUBEDB_COURIER_TAG}",
						...
						"go run ./catalog/kubedb/fmt/main.go --kind=PostgresVersion --update-spec=spec.courier.cli.image=ghcr.io/kubedb/kubedb-migrator-postgresql:${KUBEDB_MIGRATOR_TAG}",
						"go run ./catalog/kubedb/fmt/main.go --kind=PostgresVersion --update-spec=spec.courier.statusReporter.image=ghcr.io/kubedb/kubedb-courier:${KUBEDB_COURIER_TAG}",
						...
						"go run ./catalog/kubestash/fmt/main.go --kind=Function --name=etcd-backup --update-spec=spec.image=ghcr.io/kubedb/etcd-restic-plugin:${KUBEDB_ETCD_RESTIC_PLUGIN_TAG}_$${DB_VERSION}",
						"go run ./catalog/kubestash/fmt/main.go --kind=Function --name=etcd-restore --update-spec=spec.image=ghcr.io/kubedb/etcd-restic-plugin:${KUBEDB_ETCD_RESTIC_PLUGIN_TAG}_$${DB_VERSION}",
						...
						"go run ./catalog/kubestash/fmt/main.go --kind=Function --name=mariadb-physical-backup --update-spec=spec.image=ghcr.io/kubedb/mariadb-restic-plugin:${KUBEDB_MARIADB_RESTIC_PLUGIN_TAG}_$${DB_VERSION}",
						"go run ./catalog/kubestash/fmt/main.go --kind=Function --name=mariadb-physical-restore --update-spec=spec.image=ghcr.io/kubedb/mariadb-restic-plugin:${KUBEDB_MARIADB_RESTIC_PLUGIN_TAG}_$${DB_VERSION}",
						...
						"go run ./catalog/kubestash/fmt/main.go --kind=Function --name=oracle-backup --update-spec=spec.image=ghcr.io/kubedb/oracle-backup-plugin:${KUBEDB_ORACLE_BACKUP_PLUGIN_TAG}",
						"go run ./catalog/kubestash/fmt/main.go --kind=Function --name=oracle-restore --update-spec=spec.image=ghcr.io/kubedb/oracle-backup-plugin:${KUBEDB_ORACLE_BACKUP_PLUGIN_TAG}",
						...
						"go run ./catalog/kubestash/fmt/main.go --kind=Function --name=postgres-physical-backup-restore --update-spec=spec.image=ghcr.io/kubedb/postgres-restic-plugin:${KUBEDB_POSTGRES_RESTIC_PLUGIN_TAG}_$${DB_VERSION}",
						...
						"go run ./catalog/kubestash/fmt/main.go --kind=Function --name=qdrant-backup --update-spec=spec.image=ghcr.io/kubedb/qdrant-restic-plugin:${KUBEDB_QDRANT_RESTIC_PLUGIN_TAG}",
						"go run ./catalog/kubestash/fmt/main.go --kind=Function --name=qdrant-restore --update-spec=spec.image=ghcr.io/kubedb/qdrant-restic-plugin:${KUBEDB_QDRANT_RESTIC_PLUGIN_TAG}",
						...
						"go run ./catalog/kubestash/fmt/main.go --kind=Function --name=solr-backup --update-spec=spec.image=ghcr.io/kubedb/solr-backup-plugin:${KUBEDB_SOLR_BACKUP_PLUGIN_TAG}",
						"go run ./catalog/kubestash/fmt/main.go --kind=Function --name=solr-restore --update-spec=spec.image=ghcr.io/kubedb/solr-backup-plugin:${KUBEDB_SOLR_BACKUP_PLUGIN_TAG}",
						...
						"make chart-kubedb-courier CHART_VERSION=${KUBEDB_COURIER_TAG} CHART_REGISTRY=${CHART_REGISTRY} CHART_REGISTRY_URL=${CHART_REGISTRY_URL}",
						"make chart-kubedb-courier-addon-manager CHART_VERSION=${KUBEDB_COURIER_TAG} CHART_REGISTRY=${CHART_REGISTRY} CHART_REGISTRY_URL=${CHART_REGISTRY_URL}",

...
func CreateStashReleaseFile() api.Release {
	releaseNumber := "v2020.08.27-rc.0"
		...
		Projects: []api.IndependentProjects{
			{
				"github.com/stashed/apimachinery": api.Project{
					Tag: github.String("v0.10.0-rc.2"),
				},
			},
			{
			...
			},
			{
				"github.com/stashed/postgres": api.Project{
					...
					Tags: map[string]string{
						"9.6-rc.20200827":  "release-9.6",
						"10.2-rc.20200827": "release-10.2",
						"10.6-rc.20200827": "release-10.6",
						"11.1-rc.20200827": "release-11.1",
						"11.2-rc.20200827": "release-11.2",
					},
					Commands: []string{
			...
			},
			{
				"github.com/stashed/elasticsearch": api.Project{
					...
					Tags: map[string]string{
						"5.6.4-rc.20200827": "release-5.6.4",
						"6.2.4-rc.20200827": "release-6.2.4",
						"6.3.0-rc.20200827": "release-6.3.0",
						"6.4.0-rc.20200827": "release-6.4.0",
						"6.5.3-rc.20200827": "release-6.5.3",
						"6.8.0-rc.20200827": "release-6.8.0",
						"7.2.0-rc.20200827": "release-7.2.0",
						"7.3.2-rc.20200827": "release-7.3.2",
					},
					Commands: []string{
						"make update-charts CHART_VERSION=${TAG} CHART_REGISTRY=${CHART_REGISTRY} CHART_REGISTRY_URL=${CHART_REGISTRY_URL}",
					},
			...
			},
			{
				"github.com/stashed/mongodb": api.Project{
					...
					Tags: map[string]string{
						"3.4.1-rc.20200827":  "release-3.4.17",
						"3.4.2-rc.20200827":  "release-3.4.22",
						"3.6.1-rc.20200827":  "release-3.6.13",
						"3.6.8-rc.20200827":  "release-3.6.8",
						"4.0.11-rc.20200827": "release-4.0.11",
						"4.0.3-rc.20200827":  "release-4.0.3",
						"4.0.5-rc.20200827":  "release-4.0.5",
						"4.1.1-rc.20200827":  "release-4.1.13",
						"4.1.4-rc.20200827":  "release-4.1.4",
						"4.1.7-rc.20200827":  "release-4.1.7",
						"4.2.3-rc.20200827":  "release-4.2.3",
					},
					Commands: []string{
						"make update-charts CHART_VERSION=${TAG} CHART_REGISTRY=${CHART_REGISTRY} CHART_REGISTRY_URL=${CHART_REGISTRY_URL}",
					},
			...
			},
			{
				"github.com/stashed/mysql": api.Project{
					...
					Tags: map[string]string{
						"5.7.25-rc.20200827": "release-5.7.25",
						"8.0.14-rc.20200827": "release-8.0.14",
						"8.0.3-rc.20200827":  "release-8.0.3",
					},
					Commands: []string{
						"make update-charts CHART_VERSION=${TAG} CHART_REGISTRY=${CHART_REGISTRY} CHART_REGISTRY_URL=${CHART_REGISTRY_URL}",
					},

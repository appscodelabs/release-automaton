...
func CreateAceReleaseFile() api.Release {
	prerelease := ""
	releaseNumber := "v2025.6.16" + prerelease
	return api.Release{
		ProductLine: "ACE",
			...
			},
			{
				"github.com/appscode-cloud/installer": api.Project{
					...
					Commands: []string{
						...
						"make chart-outbox-syncer CHART_VERSION=${RELEASE} APP_VERSION=${RELEASE} CHART_REGISTRY=${CHART_REGISTRY} CHART_REGISTRY_URL=${CHART_REGISTRY_URL}",
